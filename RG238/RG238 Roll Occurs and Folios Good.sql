...
GROUP BY        [FAV].[Roll Year], 
       ...
       [JR].[Jurisdiction Desc], 
       [SD].[School  District Code], 
       [PC].[RowSortOrder] ,       [PC].[Property Class Code], 
...
--       [Folio Count] AS [Folio Count], 
--       [Gross Land] AS [Gross Land], 
--       [Gross Improvements] AS [Gross Improvements], 
--       [Net Land] AS [Net Land], 
--       [Net Improvements] AS [Net Improvements], 
--       [Exempt Land] AS [Exempt Land], 
--       [Exempt Improvements] AS [Exempt Improvements]
--FROM [edw].[FactAssessedValue] AS [FAV]
--     INNER JOIN [edw].[dimPropertyClass] AS [PC] ON [FAV].[dimPropertyClass_SK] = [PC].[dimPropertyClass_SK]
