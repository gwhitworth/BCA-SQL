...
SET @p_RD = '03';
--SET @p_JR = '213';
SELECT distinct  top 1000  [FA].[dimFolio_SK],
                        -- [FA].[dimAssessmentType_SK], 
                         [PC].[Property Class Code],
                        (SELECT  max( [Property Class Occurrence])
  FROM [EDW].[edw].[FactPropertyClassOccurrenceCount] WHERE [dimFolio_SK] = [FA].[dimFolio_SK] ) AS [Occur Count]
