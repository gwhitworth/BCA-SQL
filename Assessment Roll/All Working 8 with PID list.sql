...
[FACT].[dimFolio_SK], 
						...
						ISNULL([LST].[Legal Description], '') AS [Legal Description], 
                        [PID Cnt], 
                        ISNULL([PL].[PID Display], '') AS [First PID], 
                        [LST].[PID Display] AS [Additional PID], 
...
INNER JOIN [edw].[dimPropertyPIDLists] AS [LST] ON [LST].[dimProperty_SK] = [FAV].[dimPropertyClass_SK]
