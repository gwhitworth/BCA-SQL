...
SELECT TOP 20 'BCA00020' AS [Record ID], 
              ...
              CONCAT(
			  SPACE(11-LEN(FORMAT(([Previous Year1 Total Assessed Value] - [Previous Year2 Total Assessed Value])/[Previous Year2 Total Assessed Value],'P0'))),
			  ...
			  SPACE(11-LEN(FORMAT(([Previous Year2 Total Assessed Value] - [Previous Year3 Total Assessed Value])/[Previous Year3 Total Assessed Value],'P0'))),
			  ...
			  SPACE(11-LEN(ISNULL(FORMAT(([Previous Year3 Total Assessed Value] - [Previous Year4 Total Assessed Value])/[Previous Year4 Total Assessed Value],'P0'),''))),
			  ...
			  SPACE(11-LEN(ISNULL(FORMAT(([Previous Year4 Total Assessed Value] - [Previous Year5 Total Assessed Value])/[Previous Year5 Total Assessed Value],'P0'),''))),
