...
SELECT --*,
CONCAT(
	[Record ID], [Area Jurisdiction Roll],[postal Code], [Bulk mail code],[Notice Type], [Routing Type], [Form Identification], [AFP Resource], 
	[Copy Requirement],[filler],[Area],[Sch Dist],[Jurisdiction Code],[Roll Number],[Jurisdiction Description], [PIN], [Office Use/Neighbourhood Code], [Bulk mail], 
	[TYPE_SEQNUM], [Property Info], [Legal Description], [PID Nos], 
	...
	PROPERTY_BOLD_FLAG1,
			  ...
			  PROPERTY_BOLD_FLAG9,
			  PROPERTY_VALUE9,
			  PROPERTY_BOLD_FLAG10,
			  PROPERTY_VALUE10,
			  PROPERTY_BOLD_FLAG11,
			  PROPERTY_VALUE11,
			  PROPERTY_BOLD_FLAG12,
			  PROPERTY_VALUE12,
			  PROPERTY_BOLD_FLAG13,
			  PROPERTY_VALUE13,
			  PROPERTY_BOLD_FLAG14,
			  PROPERTY_VALUE14,
			  PROPERTY_BOLD_FLAG15,
			  PROPERTY_VALUE15,
			  PROPERTY_BOLD_FLAG16,
			  PROPERTY_VALUE16,
			  ADDITIONAL_BOLD_FLAG1,
			  ADDITIONAL_INFO1,
			  ADDITIONAL_BOLD_FLAG2,
			  ADDITIONAL_INFO2,
			  ADDITIONAL_BOLD_FLAG3,
			  ADDITIONAL_INFO3,
			  ADDITIONAL_BOLD_FLAG4,
			  ADDITIONAL_INFO4,
			  ADDITIONAL_BOLD_FLAG5,
			  ADDITIONAL_INFO5,
			  ADDITIONAL_BOLD_FLAG6,
			  ADDITIONAL_INFO6,
			  ADDITIONAL_BOLD_FLAG7,
			  ADDITIONAL_INFO7,
			  ADDITIONAL_BOLD_FLAG8,
			  ADDITIONAL_INFO8,
			  ADDITIONAL_BOLD_FLAG9,
			  ADDITIONAL_INFO9,
			  ADDITIONAL_BOLD_FLAG10,
			  ADDITIONAL_INFO10,
			  ADDITIONAL_BOLD_FLAG11,
			  ADDITIONAL_INFO11,
			  ADDITIONAL_BOLD_FLAG12,
			  ADDITIONAL_INFO12,
			  ADDITIONAL_BOLD_FLAG13,
			  ADDITIONAL_INFO13,SPACE(437),
	
	
	
	[Your Assessment Office Address], 
	[Folio  Info], 
	[Phone Numbers], 
	[Fax Number], 
	[Email Address], 
	...
	[Unique ID], 
	[PREV_VALUE_SET], 
	[EPIN Or Related Pin Number], 
	[PCT_CHANGE_SET], [AREA_NAME], [SD_NAME], [NEIGH_NAME], [INSERT_1_YN], [INSERT_2_YN], [INSERT_3_YN], [INSERT_4_YN],char(13)+char(10)
	--, [PDF_File_Name], [AVERAGE PERCENT]
) AS [DETAIL]
--CONCAT(
--	[Record ID], [Area Jurisdiction Roll],[postal Code]
--) AS [DETAIL]
FROM 
(
SELECT 
              'BCA00020' AS [Record ID], 
              ...
              CONCAT([SITUS Address Number Prefix], ' ', [SITUS Street Number], ' ', [SITUS Street Direction], ' ', [SITUS Address Street Name], ' ', [SITUS Street Suffix], ' ', [SITUS Street Type], SPACE(69-LEN(ISNULL(CONCAT([SITUS Address Number Prefix], ' ', [SITUS Street Number], ' ', [SITUS Street Direction], ' ', [SITUS Address Street Name], ' ', [SITUS Street Suffix], ' ', [SITUS Street Type]), '')))) AS [Property Info], 
			  ...
			  SPACE(1) AS PROPERTY_BOLD_FLAG1,
			  SPACE(35) AS PROPERTY_VALUE1,
			  SPACE(1) AS PROPERTY_BOLD_FLAG2,
			  SPACE(35) AS PROPERTY_VALUE2,
			  SPACE(1) AS PROPERTY_BOLD_FLAG3,
			  SPACE(35) AS PROPERTY_VALUE3,
			  SPACE(1) AS PROPERTY_BOLD_FLAG4,
			  SPACE(35) AS PROPERTY_VALUE4,
			  ...
			  SPACE(1) AS ADDITIONAL_BOLD_FLAG1,
			  SPACE(61) AS ADDITIONAL_INFO1,
			  SPACE(1) AS ADDITIONAL_BOLD_FLAG2,
			  SPACE(61) AS ADDITIONAL_INFO2,
			  SPACE(1) AS ADDITIONAL_BOLD_FLAG3,
			  SPACE(61) AS ADDITIONAL_INFO3,
			  SPACE(1) AS ADDITIONAL_BOLD_FLAG4,
			  SPACE(61) AS ADDITIONAL_INFO4,
			  SPACE(1) AS ADDITIONAL_BOLD_FLAG5,
			  SPACE(61) AS ADDITIONAL_INFO5,
			  ...
			  SPACE(61) AS ADDITIONAL_INFO13,




              --CONCAT('XASSESSED VALUE                VALUE             CLASS   LAND',SPACE(70-LEN('XASSESSED VALUE                VALUE             CLASS   LAND'))) AS [Property Value], 
              --'X' AS [Bold Flag], 
              --SPACE(1) AS [Formatted Property Value], 
              --SPACE(1) AS [Additional Information], 
              --SPACE(1) AS [Bullet Flag], 
              --SPACE(823) AS [Additional Information Text], 
              ...
              CONCAT([PR].[Area Code], '-', [BSD].[School District Code], '-', [PR].[Jurisdiction Code], '-', SUBSTRING([PR].[Roll Number], 1, 3), '-', SUBSTRING([PR].[Roll Number], 4, 4), '-', CONCAT(REPLICATE('0', 3-LEN(SUBSTRING([PR].[Roll Number], 7, 3))), SUBSTRING([PR].[Roll Number], 7, 3)), SPACE(59-(LEN([PR].[Roll Number])+2)-10)) AS [Folio  Info], 
              ...
              CONCAT(SPACE(17-LEN(ISNULL(FORMAT([Previous Year1 Total Assessed Value], 'C0', 'en-US'), ''))), FORMAT([Previous Year1 Total Assessed Value], 'C0', 'en-US'), SPACE(17-LEN(ISNULL(FORMAT([Previous Year2 Total Assessed Value], 'C0', 'en-US'), ''))), FORMAT([Previous Year2 Total Assessed Value], 'C0', 'en-US'), SPACE(17-LEN(ISNULL(FORMAT([Previous Year3 Total Assessed Value], 'C0', 'en-US'), ''))), FORMAT([Previous Year3 Total Assessed Value], 'C0', 'en-US'), SPACE(17-LEN(ISNULL(FORMAT([Previous Year4 Total Assessed Value], 'C0', 'en-US'), ''))), FORMAT([Previous Year4 Total Assessed Value], 'C0', 'en-US'), SPACE(17-LEN(ISNULL(FORMAT([Previous Year5 Total Assessed Value], 'C0', 'en-US'), ''))), FORMAT([Previous Year5 Total Assessed Value], 'C0', 'en-US')) AS [PREV_VALUE_SET], 
              SPACE(10) AS [EPIN Or Related Pin Number], 

			  IIF(([Previous Year1 Total Assessed Value] - [Previous Year2 Total Assessed Value]) / [Previous Year2 Total Assessed Value] > 0,'+','') AS JUNK,
			  ...
			  IIF(([Previous Year1 Total Assessed Value] - [Previous Year2 Total Assessed Value]) / [Previous Year2 Total Assessed Value] > 0,'+',''),
			  ...
			  IIF(([Previous Year2 Total Assessed Value] - [Previous Year3 Total Assessed Value]) / [Previous Year3 Total Assessed Value] > 0,'+',''),
			  ...
			  IIF(([Previous Year3 Total Assessed Value] - [Previous Year4 Total Assessed Value]) / [Previous Year4 Total Assessed Value] > 0,'+',''),
			  ...
			  IIF(([Previous Year4 Total Assessed Value] - [Previous Year5 Total Assessed Value]) / [Previous Year5 Total Assessed Value] > 0,'+',''),
              ...
              CONCAT(SPACE(10),[AG].[Area Desc], SPACE(30-LEN([AG].[Area Desc]))) AS [AREA_NAME], 
...
AND [PR].[Roll Number] = '03523000'  -- AND [postal code] is not null
) AS JUNK
