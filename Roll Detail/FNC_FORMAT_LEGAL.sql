...
BEGIN
	...
	SET @RtnLegalDesc = @RtnLegalDesc + [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](CAST(@p_project_num AS VARCHAR(50)),@p_proj_num_length), ',', 'Pipeline Project:', '');
	SET @RtnLegalDesc = @RtnLegalDesc + [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_parcel, @p_parcel_length), ',', 'Parcel', '');
	IF @p_strata_lot IS NOT NULL
	   SET @RtnLegalDesc = @RtnLegalDesc + [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_strata_lot, @p_strata_lot_length), ',', 'Strata Lot', '');
	ELSE
	   SET @RtnLegalDesc = @RtnLegalDesc + [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_lot, @p_lot_length), ',', 'Lot', '');

	SET @RtnLegalDesc = @RtnLegalDesc + [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_block, @p_block_length), ',', 'Block', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_sub_block, @p_sub_block_length), ',', 'Sub Block', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_plan, @p_plan_length), ',', 'Plan', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_sub_lot, @p_sub_lot_length), ',', [dbo].[FNC_SUB_LOT](@p_jurisdiction), '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION](([dbo].[FNC_GET_PART]([dbo].[FNC_MAX_LEN](@p_part_1, @p_part_length))), ' ', 'Part', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION](([dbo].[FNC_GET_PART]([dbo].[FNC_MAX_LEN](@p_part_2, @p_part_length))), ' ', 'of', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION](([dbo].[FNC_GET_PART]([dbo].[FNC_MAX_LEN](@p_part_3, @p_part_length))), ' ', 'of', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION](([dbo].[FNC_GET_PART]([dbo].[FNC_MAX_LEN](@p_part_4, @p_part_length))), ' ', 'of', '');
	IF SUBSTRING(LTRIM(RTRIM(@RtnLegalDesc)), LEN(LTRIM(RTRIM(@RtnLegalDesc))), 1) <> ',' 
	SET @RtnLegalDesc = LTRIM(RTRIM(@RtnLegalDesc)) + ', '
	SET @RtnLegalDesc = @RtnLegalDesc + [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_district_lot, @p_district_lot_length), ',', 'District Lot', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_legal_subdivision, @p_legal_subdivision_length), ',', 'Legal Subdivision', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_section, @p_section_length), ',', 'Section', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_TOWNSHIP_DESC](@p_township), ',', 'Township', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_range, @p_range_length), ',', 'Range', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MERIDIAN_DESC](@p_meridian), ',', 'Meridian', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_bcaao_group, @p_bcaao_group_length), ',', 'Group', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_DISTRICT_DESC](@p_land_district), ',', '', 'Land District')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_portion, @p_portion_length), ',', 'Portion', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_except_plan, @p_except_plan_length), ',', 'Except Plan', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_legal_text, @p_legal_text_length), ',', '', '');
	...
	BEGIN
	   ...
	   IF @p_nts_unit IS NOT NULL OR @p_nts_exception IS NOT NULL
		  SET @NTS =	@NTS + '-' + [dbo].[FNC_MAX_LEN](@p_nts_exception, @p_nts_exception_length)
						+ [dbo].[FNC_MAX_LEN](@p_nts_unit, @p_nts_unit_length);

	   IF @p_nts_block_num IS NOT NULL
		  SET @NTS = @NTS + '-' + [dbo].[FNC_MAX_LEN](@p_nts_block_num, @p_nts_block_num_length);
   
	   IF @p_nts_map_num IS NOT NULL
		  SET @NTS =@NTS + '/' + [dbo].[FNC_MAX_LEN](@p_nts_map_num, @p_nts_map_num_length);
	...
	BEGIN
	   IF @p_lot IS NOT NULL
		   SET @RtnLegalDesc = @RtnLegalDesc + [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_lot, @p_lot_length), ',', 'Lot', '');
	END
	SET @RtnLegalDesc = @RtnLegalDesc + [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_air_space_parcel, @p_air_space_parcel_length), ',', 'Air Space Parcel', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_lease_licence_num, @p_lease_licence_num_length), ',', 'Lease/Permit/Licence #', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_mf_num, @p_mf_num_length), ',', 'Managed Forest', '')
						+ [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_mhr_number, @p_mhr_number_length), ',', 'Manufactured Home Reg.#', '');
	IF @p_mhr_number IS NOT NULL
	BEGIN
	   IF @p_bay_no IS NOT NULL
			SET @RtnLegalDesc = @RtnLegalDesc + [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_bay_no, @p_bay_no_length), ',', 'Bay #', '');
	END
	SET @RtnLegalDesc = @RtnLegalDesc + [dbo].[FNC_APPEND_LEGAL_DESCRIPTION]([dbo].[FNC_MAX_LEN](@p_mobile_park_name, @p_mobile_park_name_length), ',', '', 'Manufactured Home Park')
	...
	IF SUBSTRING(@RtnLegalDesc, LEN(LTRIM(RTRIM(@RtnLegalDesc))), 1) = ','
	   SET @RtnLegalDesc = SUBSTRING(@RtnLegalDesc, 1, LEN(LTRIM(RTRIM(@RtnLegalDesc))) - 1);
